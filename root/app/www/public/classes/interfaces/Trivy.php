...
interface TrivyCLI
{
    ...
    public const UPDATE_DB_SHELL      = '/usr/local/bin/trivy image --download-db-only --cache-dir %s';
    public const UPDATE_DB_JAVA_SHELL = '/usr/local/bin/trivy image --download-java-db-only --cache-dir %s';
